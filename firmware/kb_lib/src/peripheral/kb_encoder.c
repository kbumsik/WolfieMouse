...
static TIM_TypeDef *_get_device(kb_encoder_device_t dev);
/* Get a HAL library handler from the object */
static inline TIM_HandleTypeDef * _get_handler (kb_encoder_t *obj);
/* Peripheral clock function */
static void _enable_device_clk (kb_encoder_device_t dev);
