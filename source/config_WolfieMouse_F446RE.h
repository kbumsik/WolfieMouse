/*
 * config_WolfieMouse_F446RE.h
 *
 *  Created on: Apr 15, 2016
 *      Author: Bumsik Kim
 */

#ifndef CONFIG_WOLFIEMOUSE_F446RE_H_
#define CONFIG_WOLFIEMOUSE_F446RE_H_
 ...
 * @{
 */
#define portLED_1_PIN	GPIO_PIN_1
#define portLED_1_PORT	GPIOB
#define portLED_2_PIN	GPIO_PIN_0
#define portLED_2_PORT	GPIOB
#define portLED_3_PIN	GPIO_PIN_11
#define portLED_3_PORT	GPIOC
#define portLED_4_PIN	GPIO_PIN_10
#define portLED_4_PORT	GPIOC

#ifdef USE_HAL_DRIVER
	#define vLED_1_Toggle()	HAL_GPIO_TogglePin(portLED_1_PORT, portLED_1_PIN)
	#define vLED_1_On()		HAL_GPIO_WritePin(portLED_1_PORT, portLED_1_PIN, GPIO_PIN_SET)
	#define vLED_1_Off()	HAL_GPIO_WritePin(portLED_1_PORT, portLED_1_PIN, GPIO_PIN_RESET)
	#define vLED_2_Toggle()	HAL_GPIO_TogglePin(portLED_2_PORT, portLED_2_PIN)
	#define vLED_2_On()		HAL_GPIO_WritePin(portLED_2_PORT, portLED_2_PIN, GPIO_PIN_SET)
	#define vLED_2_Off()	HAL_GPIO_WritePin(portLED_2_PORT, portLED_2_PIN, GPIO_PIN_RESET)
	#define vLED_3_Toggle()	HAL_GPIO_TogglePin(portLED_3_PORT, portLED_3_PIN)
	#define vLED_3_On()		HAL_GPIO_WritePin(portLED_3_PORT, portLED_3_PIN, GPIO_PIN_SET)
	#define vLED_3_Off()	HAL_GPIO_WritePin(portLED_3_PORT, portLED_3_PIN, GPIO_PIN_RESET)
	#define vLED_4_Toggle()	HAL_GPIO_TogglePin(portLED_4_PORT, portLED_4_PIN)
	#define vLED_4_On()		HAL_GPIO_WritePin(portLED_4_PORT, portLED_4_PIN, GPIO_PIN_SET)
	#define vLED_4_Off()	HAL_GPIO_WritePin(portLED_4_PORT, portLED_4_PIN, GPIO_PIN_RESET)
#else
...
#endif /* CONFIG_WOLFIEMOUSE_F446RE_H_ */
