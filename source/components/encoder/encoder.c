...
void encoder_init(void) {
	...
	Encoder_Handle.Init.Period = 0xffffffff; //0xFFFF
	Encoder_Handle.Init.Prescaler = 0xf;
	Encoder_Handle.Init.ClockDivision = TIM_CLOCKDIVISION_DIV1;
	Encoder_Handle.Init.CounterMode = TIM_COUNTERMODE_DOWN;
	...
	sEncoderConfig.IC2Polarity = TIM_ICPOLARITY_RISING; //TIM_ICPOLARITY_RISING;
